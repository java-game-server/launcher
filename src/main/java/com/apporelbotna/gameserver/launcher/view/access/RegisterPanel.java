...
public class RegisterPanel extends ChangeablePanel {
	...
	private void init() {
        ...
        registerRegisterBtn.addActionListener(a -> {
        	if(emailRegisterField.getText().isEmpty()||usernameRegisterField.getText().isEmpty()||passwordRegisterField.getPassword().length==0||password2RegisterField.getPassword().length==0) 
        	{
